...
WORKDIR /tmp
RUN \
    wget -q https://dl.google.com/go/go1.17.6.linux-arm64.tar.gz -O go.tar.gz && \
...
RUN \
    # Install findomain
    wget --quiet https://github.com/Findomain/Findomain/releases/download/5.1.1/findomain-aarch64 -O /tools/findomain/findomain && \
    chmod +x /tools/findomain/findomain && \
    ln -s /tools/findomain/findomain /usr/bin/findomain && \
    # Install assetfinder
    go install github.com/tomnomnom/assetfinder@latest && \
    # Install amass
    wget --quiet https://github.com/OWASP/Amass/releases/download/v3.5.5/amass_v3.5.5_linux_arm64.zip -O /tools/amass/amass.zip && \
